...
Casting.mm.center.INFO_RANGS = [];
	...
	Casting.mm.center.INFO_RANGS['Débutant'] = [];
		...
		Casting.mm.center.INFO_RANGS['Débutant']['max'] = 32;
	...
	Casting.mm.center.INFO_RANGS['Café-théâtre'] = [];
		...
		Casting.mm.center.INFO_RANGS['Café-théâtre']['max'] = 40;
		...
		Casting.mm.center.INFO_RANGS['Café-théâtre']['infotext'] = "Ce rang vous offre l'option <strong>Jeu Lent</strong> qui porte les cycles à 4h.<br/>La taille maximale du casting passe à 40 acteurs.<br/><em>On ne s'endort plus pendant vos films... normal personne ne vous regarde.</em>";
	Casting.mm.center.INFO_RANGS['Soldat de fortune'] = [];
		...
		Casting.mm.center.INFO_RANGS['Soldat de fortune']['max'] = 48;
		Casting.mm.center.INFO_RANGS['Soldat de fortune']['need'] = 32;
		Casting.mm.center.INFO_RANGS['Soldat de fortune']['lvlup'] = 275;
		Casting.mm.center.INFO_RANGS['Soldat de fortune']['img'] = "troopers";
		Casting.mm.center.INFO_RANGS['Soldat de fortune']['infotext'] = "Débloque la fonctionnalité des Scripts. Les Scripts permettent de pré-enregistrer un message pour chaque perso qui s'affichera en début de partie.<br/>La taille maximale du casting passe à 48 acteurs.<br/><em>Vous avez déjà convaincu des gens ? C'est plus dur que des moutons...quoique...</em>";
	Casting.mm.center.INFO_RANGS['Troupe de province'] = [];
		...
		Casting.mm.center.INFO_RANGS['Troupe de province']['max'] = 64;
		Casting.mm.center.INFO_RANGS['Troupe de province']['need'] = 24;
		Casting.mm.center.INFO_RANGS['Troupe de province']['lvlup'] = 425;
		Casting.mm.center.INFO_RANGS['Troupe de province']['img'] = "mushruvery";
		Casting.mm.center.INFO_RANGS['Troupe de province']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";
	Casting.mm.center.INFO_RANGS['Bar lounge'] = [];
		...
		Casting.mm.center.INFO_RANGS['Bar lounge']['max'] = 80;
		Casting.mm.center.INFO_RANGS['Bar lounge']['need'] = 24;
		Casting.mm.center.INFO_RANGS['Bar lounge']['lvlup'] = 625;
		Casting.mm.center.INFO_RANGS['Bar lounge']['img'] = "triple_play";
		Casting.mm.center.INFO_RANGS['Bar lounge']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";
	Casting.mm.center.INFO_RANGS['Colleur d\'affiche'] = [];
		...
		Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['max'] = 96;
		Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['need'] = 24;
		Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['lvlup'] = 925;
		Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['img'] = "page";
		Casting.mm.center.INFO_RANGS['Colleur d\'affiche']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";
	Casting.mm.center.INFO_RANGS['Opéra-Bouffe'] = [];
		...
		Casting.mm.center.INFO_RANGS['Opéra-Bouffe']['lvlup'] = 1425;
		Casting.mm.center.INFO_RANGS['Opéra-Bouffe']['img'] = "swift_fungus";
		Casting.mm.center.INFO_RANGS['Opéra-Bouffe']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Nain de jardins'] = [];
		...
		Casting.mm.center.INFO_RANGS['Nain de jardins']['lvlup'] = 2125;
		Casting.mm.center.INFO_RANGS['Nain de jardins']['img'] = "dream_theater";
		Casting.mm.center.INFO_RANGS['Nain de jardins']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Orchestre'] = [];
		...
		Casting.mm.center.INFO_RANGS['Orchestre']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Ballet National'] = [];
		...
		Casting.mm.center.INFO_RANGS['Ballet National']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Opéra'] = [];
		...
		Casting.mm.center.INFO_RANGS['Opéra']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Maison de production'] = [];
		...
		Casting.mm.center.INFO_RANGS['Maison de production']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Société événementielle'] = [];
		...
		Casting.mm.center.INFO_RANGS['Société événementielle']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
	Casting.mm.center.INFO_RANGS['Légende'] = [];
		...
		Casting.mm.center.INFO_RANGS['Légende']['infotext'] = "Inconnu ! Envoyez votre casting à BSiPion pour qu'il fasse un mise à jour.";Casting.mm.center.info = {};
